...
{% block body %}
    ...
    <div class="container">
        <br />
    <h5><b>Adicionar Item de Medicamento Ministrado</b></h5>
        <div class="row">
            <div class ="col-md-12">
                ...
                <div class="form-group">
                    <label for="{{ form.unitary_price.id_for_label }}">Preco Unitario</label>
                    {{ form.unitary_price|add_class:"form-control" }}
                </div>
                <div class="form-group">
